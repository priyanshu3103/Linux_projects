...
main(){
	...
	install_awscli || exit 1
    	...
    	AMI_ID="ami-05c969369880fa2c2"
    	INSTANCE_TYPE="t2.micro"
    	KEY_NAME="linux_ec2"
    	SUBNET_ID="subnet-0ef361ac3d8d0442b"
    	SECURITY_GROUP_IDS="sg-0108802f11b8c657d"  # Add your security group IDs separated by space
    	INSTANCE_NAME="create-EC2-linux"
